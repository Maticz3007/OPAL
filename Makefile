...
#	gcc main.c solver_BFS.c queue_BFS.c chunkenizer.c chunk_manager.c maze_storage.c RLE_decompressor.c solution_output.c file_check.c error_messages.c -Wall --pedantic -lm -ggdb
	gcc main.c solver_BFS.o queue_BFS.o chunkenizer.o chunk_manager.o maze_storage.o RLE_decompressor.o solution_output.o file_check.o error_messages.o -Wall --pedantic -lm -o OPAL.out
